...
from dpcnet.losses import gan_g_loss, gan_d_loss, l2_loss, TripletLoss,toNE,trajectory_displacement_error,value_error,trajectory_diff,value_diff
from dpcnet.losses import displacement_error, final_displacement_error
from dpcnet.losses import burgers_loss
    ...
    with torch.no_grad():
        for batch in loader:
            ...
            (obs_traj, pred_traj_gt, obs_traj_rel, pred_traj_gt_rel,
             ...
             obs_date_mask, pred_date_mask,u_image_obs, v_image_obs, u_image_pre, v_image_pre,image_obs,image_pre) = batch
